...
$(document).ready(function() {
    ...
    $("#gather_button").on('click', function(evt) {
        ...
        .then(function(gatheringPoint) {
            ...
            *
            */
            console.log("Meeting place: " + gatheringPoint);
    ...
    */
    service.nearbySearch(request, function businessOptions(response, status) {
        if (response[businessIndex]){
            ...
            $(".next_spot").hide();
            alert("Sorry, there is no " + type + " near your meeting place.");
            $("#gather_button").prop('disabled',false);
...
function displayMap(placeAddress, methodTransportOne, methodTransportTwo) {
    ...
    var src1 = "https://www.google.com/maps/embed/v1/directions?key=" + "AIzaSyBNWYQm6XecIaAaJBvnq4BYyVWB2ORsxig" + "&origin=" + addressOne + "&destination=" + placeAddress + "&mode=" + methodTransportOne;
    var src2 = "https://www.google.com/maps/embed/v1/directions?key=" + "AIzaSyBNWYQm6XecIaAaJBvnq4BYyVWB2ORsxig" + "&origin=" + addressTwo + "&destination=" + placeAddress + "&mode=" + methodTransportTwo;
